...
public class ExchangeController {
    ...
    public ResponseBean<String> addExchange(Exchange exchange, HttpSession session) {
        ...
        GiftWithBLOBs nebanglinift = new GiftWithBLOBs();
        nebanglinift.setId(gift.getId());
        nebanglinift.setQuantity(gift.getQuantity() - 1);
        giftService.updateGiftSelectiveById(nebanglinift);
